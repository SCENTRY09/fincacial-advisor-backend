...
SCRIPT_DIR = Path(__file__).resolve().parent  # ML/rag/retrieval/
RAG_DIR = SCRIPT_DIR.parent  # ML/rag/
ML_DIR = RAG_DIR.parent  # ML/
PROJECT_ROOT = ML_DIR.parent  # financial_advisor/
